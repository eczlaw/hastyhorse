...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		if not dp or Duel.GetFieldGroupCount(dp,LOCATION_DECK,0)<3 then return false end
		local g=Duel.GetDecktopGroup(dp,3)
