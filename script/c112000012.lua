--Terrors of the Overroot (Hasty Horse)
...
function s.tgtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g2=Duel.GetMatchingGroup(s.setfilter,tp,LOCATION_GRAVE,LOCATION_GRAVE,nil,e,tp)
	if chk==0 then return dp and #g1>0 and #g2>0 and aux.SelectUnselectGroup(g1+g2,e,tp,2,2,s.rescon,0) end
